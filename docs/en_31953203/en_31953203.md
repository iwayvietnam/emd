...
Toàn bộ chi tiết của toàn bộ loạt bài có thể được tìm thấy trong phần 1 [10].
...
điện tử một cách an toàn và đáng tin cậy. Đặc biệt chú trọng đến Quy định (EU) số 910/2014 [i.5]. Tuy nhiên, hiệu lực pháp lý nằm
...
theo các khái niệm và ngữ nghĩa được xác định trong ETSI EN 319 522 phần 1 [7] và 2 [8] và ETSI EN 319 532 phần 1 [10] và 2 [11].
...
#### III.1. Định nghĩa
Đối với mục đích của tài liệu này, các điều khoản được đưa ra trong ETSI EN 319 532-1 [10] được áp dụng.

#### III.2. Từ viết tắt
Đối với mục đích của tài liệu này, các chữ viết tắt được đưa ra trong ETSI EN 319 532-1 [10] được áp dụng.
...
nghĩa từ ETSI EN 319 521 [i.4] và ETSI EN 319 522 [7], [8] và [9].

ETSI EN 319 532-2 [11], điều khoản 4.1 quy định việc sử dụng tiền tố ERD so với REM hoặc ERDS so với REMS để đặt tên cho các khái
...
định nghĩa định dạng của ETSI EN 319 522-3 [9] được xem xét theo quan điểm REM. Các tham chiếu ngầm định khác là đến ETSI EN 319
532-2 [11], điều khoản 4 mô tả nội dung.
...
Như được nêu trong ETSI EN 319 522-2 [8], điều khoản 4, nội dung người dùng là nội dung do người gửi tạo ra hoặc cung cấp, nhằm
...
tử của Đối tượng Thư như được định nghĩa trong IETF RFC 5321 [14], điều khoản 2.3.1 và với các định nghĩa có trong ETSI EN 319
522-1 [7], điều khoản 3.1, ETSI EN 319 522-2 [8], điều khoản 4 và ETSI EN 319 532-2 [11], điều khoản 4.
...
|------------------------|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| user content           | **user content**           | Đây là phần thân của Đối tượng Thư như được định nghĩa trong IETF RFC 5321 [14], điều khoản 2.3.1 (ghi chú 1). Nó được tạo ra bởi người gửi dưới trách nhiệm kỹ thuật/pháp lý của người gửi. Xem thêm ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                                                                                                                                                                        |
| submission metadata    | **submission metadata**    | Đây là phần tiêu đề của Đối tượng Thư như được định nghĩa trong IETF RFC 5321 [14], điều khoản 2.3.1. Xem hình 1, hình 4 và cả các định nghĩa trong ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                                                                                                                                                                                                                          |
|                        | **original message**       | Điều này bao gồm tiêu đề + nội dung như được định nghĩa trong IETF RFC 5321 [14], điều khoản 2.3.1. Nó được tạo bởi tác nhân người dùng ERD của người gửi hoặc dưới trách nhiệm kỹ thuật/pháp lý của người gửi (và nằm ngoài trách nhiệm của dịch vụ), cuối cùng có thể được người gửi ký điện tử (ghi chú 1). Xem hình 1, hình 4 và cả các định nghĩa trong ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                 |
| ERDS relay metadata    | **REMS relay metadata**    | Đây là phần tiêu đề (như được định nghĩa trong IETF RFC 5321 [14]) của thông điệp REM. Phần giới thiệu REMS cũng được coi là một phần của siêu dữ liệu chuyển tiếp REMS. Xem từ hình 1 đến hình 4 và cả các định nghĩa trong ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                                                                                                                                                 |
| ERDS handover metadata | **REMS handover metadata** | Tương tự như việc ánh xạ siêu dữ liệu chuyển tiếp REMS với ngữ nghĩa được xác định trong ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                                                                                                                                                                                                                                                                                     |
| ERDS evidence          | **ERDS evidence**          | Một trong những phương pháp có thể sử dụng để vận chuyển bằng chứng ERDS trong REM là một phần thân đính kèm (như được định nghĩa trong IETF RFC 2045 [12]) của thông điệp REM. Xem từ hình 1 đến hình 3 và cả các định nghĩa trong ETSI EN 319 532-2 [11], điều khoản 4.                                                                                                                                                                                                                          |
| ERDS serviceInfo       | **REMS notification**      | Xem hình 3 để biết cấu trúc của đối tượng này và các định nghĩa trong ETSI EN 319 532-1 [10], điều khoản 3.1. Sự khác biệt so với ERDS serviceInfo là thông báo REMS luôn chứa tham chiếu đến nội dung người dùng. Hơn nữa, nó có thể tùy chọn mang theo bằng chứng liên quan.                                                                                                                                                                                                                     |
| ERD message            | **REM message**            | Xem từ hình 1 đến hình 4 để biết tất cả các cấu trúc có thể có trong các bộ phận (như được định nghĩa trong IETF RFC 2045 [12]).                                                                                                                                                                                                                                                                                                                                                                   |
| ERD payload            | **REM payload**            | Xem hình 4 để biết cấu trúc của đối tượng này và cũng như định nghĩa trong ETSI EN 319 521 [i.4], điều khoản 3 và ETSI EN 319 522-1 [7], điều khoản 3.                                                                                                                                                                                                                                                                                                                                             |
| ERD dispatch           | **REM dispatch**           | Xem hình 1 để biết cấu trúc của đối tượng này và cũng như định nghĩa trong ETSI EN 319 521 [i.4], điều khoản 3 và ETSI EN 319 522-1 [7], điều khoản 3 và các chi tiết khác trong ETSI EN 319 532-2 [11], điều khoản 4. Đó là một đối tượng mới (theo cấu trúc thông báo REM) được tạo bởi Dịch vụ REM bao gồm thông báo gốc và các nội dung khác được tạo bởi Dịch vụ REM, dịch vụ này chỉ chịu trách nhiệm về một phần nội dung của nó (nó không chịu trách nhiệm về nội dung của thông báo gốc). |
|                        | **transport metadata**     | Khi tin nhắn gốc được gửi qua SMTP, đây là thông tin vận chuyển và thông tin đóng được truyền tải trong một phiên SMTP điển hình (xem hình A.1). Nó bao bọc tin nhắn gốc bên trong giao dịch SMTP và chứa các lệnh và thông tin trả lời được truyền trong quá trình giao tiếp giữa máy khách và máy chủ, như được định nghĩa trong IETF RFC 5321 [14] (ghi chú 2).                                                                                                                                 |
...
phần đính kèm, theo đặc tả tiêu chuẩn MIME, như được cung cấp trong IETF RFC 2045 [12], điều khoản 2.6.
...
này và được quản lý trong ETSI EN 319 532-4 [i.1], điều khoản 5.3.5 - CSI.
...
> LƯU Ý 3: Các trường tiêu đề khác (ví dụ: như trường được sử dụng để ánh xạ siêu dữ liệu của ETSI EN 319 532-2 [11], điều khoản
...
Điều khoản này quy định cấu trúc của một thông báo REM dựa trên định dạng MIME (xem IETF RFC 2045 [12]). Một thông báo REM không
...
ETSI EN 319 532-1 [10]. Việc xác định cách thông điệp REM chung được điều chỉnh cho chế độ hoạt động và giao diện cụ thể mà nó
...
gồm một số phần thân như được định nghĩa trong MIME (IETF RFC 2045 [12]). Phần thân thông báo phải có dạng các phần
...
dựng như được chỉ ra trong bảng 1 của ETSI EN 319 532-2 [11], điều khoản 4.1, mà đến lượt nó được lấy từ bảng 1 của ETSI EN 319
522-2 [8], điều khoản 4.

Điều phối REM sẽ được cấu trúc như trong hình 1.

Biên lai REMS sẽ được cấu trúc như trong hình 2.

Thông báo REMS phải được cấu trúc như trong hình 3 và phải được tạo bởi REMS theo các yêu cầu về luồng của ETSI EN 319 532-1 [10],
điều khoản 4 và ETSI EN 319 532-2 [11], điều khoản 4.

Cấu trúc tải trọng REM sẽ như trong hình 4.

Chúng được xây dựng bắt đầu từ cấu trúc thông báo ERD, được định nghĩa trong bảng 1 của ETSI EN 319 522-2 [8], điều khoản 4,
...
Đối với các định dạng nhận dạng REMS, ETSI EN 319 522-2 [8], điều khoản 5, các thành phần nhận dạng được xác định trong bảng 6 của
ETSI EN 319 522-2 [8], điều khoản 8.1 và các định dạng được xác định trong ETSI EN 319 522-3 [9], điều khoản 5 sẽ được áp dụng.

REMS sẽ gán cho mỗi người dùng một mã định danh duy nhất, như được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 5.2 ở định
dạng địa chỉ email, được định nghĩa là "addr-spec" trong phần 3.4.1 của IETF RFC 5322 [4].
...
#### VI.1. Yêu cầu chung
Điều khoản hiện tại xác định các định dạng siêu dữ liệu chuyển tiếp REMS. Để phục vụ mục đích này, ETSI EN 319 532-2 [11],
...
Các yêu cầu về sự hiện diện được xác định trong bảng 5 của ETSI EN 319 522-2 [8] và điều khoản 6.2.1 của ETSI EN 319 532-2 [11]
(đối với các thành phần siêu dữ liệu được sao chép bởi ERDS), trong bảng 13 của ETSI EN 319 522-2 [8] (đối với các thành phần bằng
...
|--------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Phiên bản siêu dữ liệu                                       | REM-MetadataVersion: trường tiêu đề. Giá trị này phải được định dạng theo quy định trong ETSI EN 319 522-2 [8], điều khoản 6.2.1 - MD01 và nó phải chứa số phiên bản của tài liệu hiện tại theo định dạng EN31953203<phiên bản> (với chữ 'V' viết hoa và thay thế dấu chấm bằng 0, ví dụ: nếu phiên bản hiện tại là v1.2.1 thì phiên bản MetaData là EN31953203V010201).                                                                   |
| Ngày và giờ chuyển tiếp                                      | REM-RelayDate: trường tiêu đề. Định dạng của giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.2 - MD02 và ETSI EN 319 522-3 [9], điều khoản 4.3.7 và được ánh xạ theo điều khoản 3.3 của IETF RFC 5322 [4].                                                                                                                                                                                                      |
| Ngày và giờ hết hạn                                          | REM-ExpirationDate: trường tiêu đề. Định dạng của giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.3 - MD03 và ETSI EN 319 522-3 [9], điều khoản 4.3.8. được ánh xạ theo điều khoản 3.3 của IETF RFC 5322 [4].                                                                                                                                                                                                   |
| Mức độ đảm bảo yêu cầu của người nhận                        | REM-RecipientAssuranceLevel: trường tiêu đề. Giá trị này đại diện cho ngữ nghĩa được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 6.2.4 - MD04 sẽ được định dạng theo các lựa chọn phù hợp trong số những lựa chọn được định nghĩa trong ETSI EN 319 522-3 [9], điều khoản 4.3.14 và được ánh xạ thành URI trong REM theo các cơ chế mở rộng được định nghĩa trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc. |
| Chính sách áp dụng                                           | REM-ApplicablePolicy: trường tiêu đề. Giá trị này phải được định dạng theo quy định trong ETSI EN 319 522-2 [8], điều khoản 6.2.5 - MD05 và ETSI EN 319 522-3 [9], điều khoản 4.3.15. Nếu có nhiều hơn một chính sách áp dụng, thì trường tiêu đề sẽ xuất hiện nhiều lần khi cần thiết và mỗi lần xuất hiện sẽ chứa một trong các chính sách áp dụng.                                                                                      |
| Phương thức vận chuyển                                       | REM-ModeOfConsignment: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.6 - MD06. Nó phải chứa một trong các URI được xác định trong ETSI EN 319 522-3 [9], điều khoản 4.3.16.                                                                                                                                                                                                                   |
| Giao hàng theo lịch trình                                    | REM-ScheduledDelivery: trường tiêu đề. Định dạng của giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.7 - MD07 và ETSI EN 319 522-3 [9], điều khoản 4.3.9 và được ánh xạ theo điều khoản 3.3 của IETF RFC 5322 [4].                                                                                                                                                                                              |
| Mã định danh người gửi                                       | Giá trị này phải có ngữ nghĩa được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.8 - MD08, nó phải được định dạng như được quy định trong ETSI EN 319 522-3 [9], điều khoản 4.3.10 và được ánh xạ trong REM theo các cơ chế mở rộng được xác định trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc.                                                                                                           |
| Thư trả lời của người gửi tới địa chỉ                        | Reply-To: trường tiêu đề. Giá trị này phải có ngữ nghĩa được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.9 - MD09, nó phải được định dạng như được chỉ định trong điều khoản 5. Trong các thông báo REM, nó phải được ánh xạ như được chỉ định trong bảng 3 của điều khoản 6.2.1.                                                                                                                                                 |
| Mã định danh người nhận                                      | Giá trị này phải có ngữ nghĩa được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.10 - MD10, nó phải được định dạng như được quy định trong ETSI EN 319 522-3 [9], điều khoản 4.3.12 và được ánh xạ trong REM theo các cơ chế mở rộng được xác định trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc.                                                                                                          |
| Mã định danh thông báo ERD                                   | Message-ID: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.11 - MD11 và ETSI EN 319 522-3 [9], điều khoản 4.3.4. Trong REM, nó phải được ánh xạ như trong bảng 3 của điều khoản 6.2.1.                                                                                                                                                                                                         |
| Đáp lại                                                      | In-Reply-To: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.12 - MD12 và ETSI EN 319 522-3 [9], điều khoản 4.3.6. Trong REM, nó phải được ánh xạ như trong điều khoản 3.6.4 của IETF RFC 5322 [4].                                                                                                                                                                                             |
| Thông tin nội dung người dùng: Loại nội dung                 | Content-Type: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.14 - MD14 và ETSI EN 319 522-3 [9], điều khoản 4.3.13. Trong REM, nó phải được ánh xạ như trong bảng 3 của điều khoản 6.2.1.                                                                                                                                                                                                      |
| Thông tin nội dung người dùng: Chủ đề                        | Subject: trường tiêu đề. Giá trị này sẽ được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.14 - MD14 và ETSI EN 319 522-3 [9], điều khoản 4.3.4. Trong REM, nó sẽ được ánh xạ như trong bảng 3 của điều khoản 6.2.1.                                                                                                                                                                                                                |
| Loại thông báo ERD                                           | REM-MessageType: trường tiêu đề. Giá trị này phải được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 6.2.13 - MD13. Nó phải chứa một trong các URI được định nghĩa trong ETSI EN 319 522-3 [9], điều khoản 4.3.5, ngoại trừ trường hợp thông báo REMS, khi đó giá trị phải là: http://uri.etsi.org/19522/v1#/ERDMessageType/notification                                                                                              |
| Thông tin nội dung người dùng: Thuật toán tóm tắt            | REM-DigestAlgorithm: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.14 - MD14 và ETSI EN 319 522-3 [9], điều khoản 4.3.13. Trong REM, nó phải được ánh xạ thành URI tuân thủ phần 4.2 của IETF RFC 6931 [i.9].                                                                                                                                                                                 |
| Thông tin nội dung người dùng: Tóm tắt tin nhắn              | REM-DigestValue: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.14 - MD14 và ETSI EN 319 522-3 [9], điều khoản 4.3.13. Trong REM, nó phải chứa giá trị băm được mã hóa base64 của thông điệp gốc được tính toán bằng cách sử dụng thuật toán băm được chỉ ra trong trường tiêu đề đã đề cập ở trên.                                                                                            |
| Thông tin nội dung người dùng: Mã định danh gốc của tin nhắn | REM-UAMessageIdentifier: trường tiêu đề. Giá trị này phải được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 6.2.11 - MD11 (được ánh xạ với định danh giao thức lớp ứng dụng, điều khoản 6.2.14 - MD14) và ETSI EN 319 522-3 [9], điều khoản 4.3.4 (trong đó được định nghĩa là AppLayerIdentifier ETSI EN 319 522-3 [9], điều khoản 4.3.13). Trong REM, nó phải chứa giá trị Message-ID của thông báo gốc được gửi bởi ERD-UA.       |
| Thông tin nội dung người dùng: AttachmentInformation         | Giá trị này sẽ được định dạng theo quy định trong ETSI EN 319 522-2 [8], điều khoản 6.2.14. Trong REM, nó liên quan đến thông tin đính kèm được chứa sẵn trong các trường tiêu đề MIME (xem ghi chú 1 trong bảng 1). Điều này có thể được ánh xạ rõ ràng hơn nữa trong REM theo các cơ chế mở rộng được định nghĩa trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc.                                                 |
| Chữ ký                                                       | Xem các trường tiêu đề trong điều khoản 6.2.7.                                                                                                                                                                                                                                                                                                                                                                                             |
| Mã nhận dạng bằng chứng                                      | REM-Evidence-ID: trường tiêu đề. Giá trị này phải được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 8.2.1 - G01. Nó phải chứa thành phần định danh bằng chứng và trong REM, nó phải được ánh xạ với cùng định dạng như tiêu đề Message-ID:                                                                                                                                                                                           |
| Mã định danh sự kiện                                         | REM-EventIdentifier: trường tiêu đề. Giá trị này phải được xác định trong ETSI EN 319 522-2 [8], điều khoản 8.2.3 - G03. Nó phải chứa URI được xác định trong bảng 2 của ETSI EN 319 522-3 [9], điều khoản 5.2.2.5.                                                                                                                                                                                                                        |
| Mã định danh lý do                                           | REM-ReasonIdentifier: trường tiêu đề. Giá trị này phải được định nghĩa trong ETSI EN 319 522-2 [8], điều khoản 8.2.3 - G04. Nó phải chứa thành phần định danh lý do và trong REM, nó phải được ánh xạ dưới dạng URI. Nó có thể được ánh xạ theo các cơ chế mở rộng được định nghĩa trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc.                                                                                 |
| Phần mở rộng                                                 | Siêu dữ liệu khác có thể được chỉ định bằng cơ chế mở rộng được xác định trong điều khoản 6.2.1 hoặc điều khoản 6.2.5 cho thông tin có cấu trúc. Giá trị này phải được định dạng như được xác định trong ETSI EN 319 522-2 [8], điều khoản 6.2.15 - MD015 và ETSI EN 319 522-3 [9], điều khoản 4.3.17.                                                                                                                                     |
...
| Message-ID:        | Giá trị cho trường tiêu đề này phải là UID như được định nghĩa trong IETF RFC 5322 [4]                                                                                                                                                                                                                                                                                                          | Bắt buộc  | Mục 3.6.4 IETF RFC 5322                          |
...
tắc đặt tên tốt nhất hiện hành được khuyến nghị trong IETF RFC 6648 [i.3], điều khoản 3, không có tiền tố X-. Các tiêu đề
...
theo các yêu cầu được xác định trong ETSI EN 319 532-2 [11], điều khoản 6.2.1:
...
cuối tệp của tin nhắn gốc và dấu xuống dòng thứ hai là do yêu cầu được quy định trong IETF RFC 2046 [13], điều khoản 5.1.1 (phải
...
* REM-Extension-Code: giá trị phải chứa mã thành phần xác định siêu dữ liệu hoặc thành phần bằng chứng liên quan trong bảng 5 hoặc bảng 6 của ETSI EN 319 522-2 [8] (ví dụ: I06...).
* Thành phần "name" của trường tiêu đề Content-Type: \<REM_EXTENSION_NAME\> phải dựa trên tên thành phần xác định siêu dữ liệu
hoặc thành phần bằng chứng liên quan trong bảng 5 hoặc bảng 6 của ETSI EN 319 522-2 [8]
...
nêu chi tiết trong ETSI EN 319 532-1 [10], điều khoản 6.

Các yêu cầu đối với bằng chứng XML ERDS được xác định trong ETSI EN 319 522-3 [9], điều khoản 5 sẽ được áp dụng.
...
Các yêu cầu và giải thích được đưa ra trong điều khoản 7.2 và 7.3 của ETSI EN 319 522-4-3 [i.8] nên được áp dụng cho REM,
...
Trong ví dụ của hình A.1, hoàn toàn tuân thủ IETF RFC 5321 [14], thông điệp gốc thể hiện phần cơ bản được kiểm tra
trong tài liệu này.
...
này và được xử lý ở một mức độ nào đó trong ETSI EN 319 532-4 [i.1], điều khoản 5.3.5 - CSI.
